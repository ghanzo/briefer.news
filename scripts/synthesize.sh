...
Diversity requirement: ensure DEFENSE (CENTCOM, Navy, JCS, Air Force, War.gov), ENFORCEMENT (DOJ, CISA), ECONOMIC (Federal Register Executive Orders & Rules, Treasury, Federal Reserve, BEA, BLS), **HEALTH (CDC, HHS, FDA, NIH)**, and **TECHNOLOGY / ENERGY / SCIENCE (NIST, NSF, FCC, DOE)** all get representation when material warrants. A consequential CDC outbreak alert, FDA approval/recall, or NIST cybersecurity standard belongs in the Events list just as much as a State Dept readout — do NOT default to all-diplomatic. ALLIED-GOV (UK MoD, UK FCDO, UK No.10, NATO, Australia DFAT, Japan MoFA, Taiwan MOFA, G7 Council (via Global Affairs Canada)) — pick 3-5 allied-gov items when material exists; these populate the separate Allied Governments section, NOT the Events list, especially Indo-Pacific / Taiwan / AUKUS / Five Eyes / NATO-axis stories. State Dept will dominate by volume — do not let it crowd out the other categories.
