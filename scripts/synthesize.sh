...
- Render as a COMPLETE HTML FILE matching ${REPO}/research/prototype_us_2026-05-12.html. Preserve all CSS, the <header>, <footer>, and <script> blocks unchanged. Only replace:
  ...
  - **No dek-bullets block.** The headline is followed directly by the thread-strip (if any) and then the events block. Skim view is the 5 event ledes; DEK.md's plain-English rules apply to those ledes.
