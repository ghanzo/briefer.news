...
- <ul class="items">...</ul> — the EVENTS block, now holding **ALL 9 events fully visible** (no expander). These are the day's **NINE MOST CONSEQUENTIAL** DISTINCT items, ordered by significance. Cite numerals 1-9. **FLAT FULL-BODY FORMAT (2026-05-30, no chevron):** each <li> shows its bold lede AND full body directly — NO <details>/<summary> wrapping, NO click-to-expand. Format: <li><b>Lede.</b> body text<sup><a class="cite" href="..." title="...">N</a></sup><span class="when">Mon DD &middot; Source</span></li>. The cite numeral links directly to the source.
