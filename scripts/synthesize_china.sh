...
- **No more-events block.** Removed 2026-05-27. The brief renders ONLY the visible top-5 events. Do not produce `<details class="more-events">`, `<ul class="items items-more">`, or any "Show more events" expander. Sources bibliography contains only the 5 cited events (numbered 1-5). **Layout order**: Events (5, no expander) → This week (placeholder, injected post-synth) → Outside the Gate → Voices → Strategic Backdrop → Five-Year Plan → Sources.
